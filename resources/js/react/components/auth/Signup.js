...
class Signup extends Component{
    ...
    onSubmit = (e)=> {
        ...
        if(validation.passes()){
            ...
            this.props.signup(this.state.form).then((res)=>{
                this.setState({...this.state, form:{name: '', email: '', password: '', password_confirmation:''}});
                            ...
                            <form onSubmit={this.onSubmit}>
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6">
                                        <input id="name" type="text" {...inputValue({key:'name'})} autoFocus />
                                        { errorMsg({key: 'name'}) }
                                    </div>
                                </div>
...
export default connect(false,{signup})(FormHandler(Signup));