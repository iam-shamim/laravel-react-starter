...
/* harmony import */ var _store_action_authAction__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../store/action/authAction */ "./resources/js/react/store/action/authAction.js");
...
/* harmony import */ var validatorjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! validatorjs */ "./node_modules/validatorjs/src/validator.js");
/* harmony import */ var validatorjs__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(validatorjs__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _utils_FormHandler__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils/FormHandler */ "./resources/js/react/utils/FormHandler.js");
...
/*#__PURE__*/
function (_Component) {
  _inherits(PasswordResetConfirm, _Component);
  ...
  function PasswordResetConfirm(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(PasswordResetConfirm).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      ...
      errors: new validatorjs__WEBPACK_IMPORTED_MODULE_4___default.a([], []).errors
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "onSubmit", function (e) {
      ...
      var validation = new validatorjs__WEBPACK_IMPORTED_MODULE_4___default.a(_this.state.form, rules);
      ...
      if (validation.passes()) {
        ...
        _this.props.resetPasswordAction(_objectSpread({}, _this.state.form, {
          ...
          react_redux_toastr__WEBPACK_IMPORTED_MODULE_3__["toastr"].success('Success', res.data.msg);

          _this.props.history.push('/login');
        })["catch"](function (error) {
          react_redux_toastr__WEBPACK_IMPORTED_MODULE_3__["toastr"].error('Error', error.response.msg);

          if (error.response.error_type === "validation_error") {
            _this.props.addValidationErrors(validation, error.response.errors);
          }
    ...
    _this.props.initRef(_assertThisInitialized(_this));

    return _this;
  }

  _createClass(PasswordResetConfirm, [{
    key: "render",
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(false, {
  resetPasswordAction: _store_action_authAction__WEBPACK_IMPORTED_MODULE_2__["resetPasswordAction"]
})(Object(_utils_FormHandler__WEBPACK_IMPORTED_MODULE_5__["default"])(PasswordResetConfirm)));

/***/ }),

/***/ "./resources/js/react/utils/FormHandler.js":
/*!*************************************************!*\
  !*** ./resources/js/react/utils/FormHandler.js ***!
  \*************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function (ComposedComponent) {
  ...
  /*#__PURE__*/
  function (_Component) {
    _inherits(FormHandler, _Component);
    ...
    function FormHandler() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(FormHandler)).call.apply(_getPrototypeOf2, [this].concat(args)));

      _defineProperty(_assertThisInitialized(_this), "initRef", function (ref) {
        _this.child = ref;
      });

      _defineProperty(_assertThisInitialized(_this), "inputValue", function (_ref) {
        var _ref$groupKey = _ref.groupKey,
            groupKey = _ref$groupKey === void 0 ? 'form' : _ref$groupKey,
            key = _ref.key,
            _ref$initVal = _ref.initVal,
            initVal = _ref$initVal === void 0 ? false : _ref$initVal,
            _ref$classes = _ref.classes,
            classes = _ref$classes === void 0 ? 'form-control' : _ref$classes;
        return {
          name: key,
          value: initVal ? initVal : _this.child.state[groupKey][key],
          onChange: function onChange(e) {
            return _this.onChange(e, groupKey);
          },
          className: classnames__WEBPACK_IMPORTED_MODULE_1___default()(classes, {
            'is-invalid': _this.child.state.errors.has(key)
          })
        };
      });

      _defineProperty(_assertThisInitialized(_this), "errorMsg", function (_ref2) {
        var key = _ref2.key,
            _ref2$errorsKey = _ref2.errorsKey,
            errorsKey = _ref2$errorsKey === void 0 ? 'errors' : _ref2$errorsKey;
        return _this.child.state[errorsKey].has(key) && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          className: "invalid-feedback",
          role: "alert"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("strong", null, _this.child.state[errorsKey].first(key)));
      });

      _defineProperty(_assertThisInitialized(_this), "onChange", function (e, groupKey) {
        var value = e.target.type === 'checkbox' && !e.target.checked ? "" : e.target.value;

        _this.child.setState(_objectSpread({}, _this.child.state, _defineProperty({}, groupKey, _objectSpread({}, _this.child.state[groupKey], _defineProperty({}, e.target.name, value)))));
      });

      _defineProperty(_assertThisInitialized(_this), "addValidationErrors", function (validation, resError) {
        Object.keys(resError).map(function (errorKey) {
    ...
    _createClass(FormHandler, [{
      ...
      value: function render() {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ComposedComponent, _extends({}, this.props, {
          ...
          addValidationErrors: this.addValidationErrors
        }));
      }
    }]);
